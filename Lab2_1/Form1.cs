                        ...
                        while (client.Connected)
                        {
                            ...
                            switch (serverMethod)
                            {
                                case "listFiles":
                                    ...
                                    foreach (var file in Directory.GetFiles(directory))
                                    {
                                        if (file.EndsWith(".exe"))
                                        {
                                            ...
                                            textStatus.Text += "Sending file " + file.Substring(indexDelimeter + 1) +
                                                               Environment.NewLine;
                                ...
                                case "sendFile":
                                    ...
                                    using (BinaryWriter bw = new BinaryWriter(client.GetStream(),  new UTF8Encoding(false, true), leaveOpen: true))
                                    {
